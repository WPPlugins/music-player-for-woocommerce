...
if( !class_exists( 'WCMP_PLAYLIST_WIDGET' ) )
{
	class WCMP_PLAYLIST_WIDGET extends WP_Widget
	{
		...
		function form($instance)
		{
			...
			$preload					= (!empty($global_settings['preload'])) ? $global_settings['preload'] : 'metadata';
			?>
			<p>
		...
		function update($new_instance, $old_instance)
		{
			...
			$instance['play_all'] = $new_instance['play_all'];
			$instance['preload'] = $new_instance['preload'];

			$global_settings = array('preload' => 'metadata');
			if(!empty($instance['play_all'])) $global_settings['play_all'] = true;
			if(
				!empty($instance['preload']) &&
				in_array($instance['preload'], array('none','metada','auto'))
			) $global_settings['preload'] = $instance['preload'];
